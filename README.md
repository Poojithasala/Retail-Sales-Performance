...
- Customers (Customer ID, Name, Gender, City, Join Date)
- Products (Product ID, Product Name, Category, Price)
- Sales (Sale ID, Customer ID, Product ID, Order Date, Quantity, Total Amount)
...
GitHub: https://github.com/Poojithasala
